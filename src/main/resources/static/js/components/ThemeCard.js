export class ThemeCard {
    ...
    createCard() {
        ...
        card.innerHTML = `
        <div data-theme-id="${this.theme.id}" class="card theme-${this.theme.id}">
			...
			<div id="theme${this.theme.id}Collapse" class="collapse show" aria-labelledby="theme${this.theme.id}Heading" data-bs-parent="'#themeAccordion'">
				<div class="card-body">
					...
					<div class="modal-content">
						...
						<div class="modal-body">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" id="editThemeName${this.theme.id}" placeholder="Theme name" value="${this.theme.themeName}">
